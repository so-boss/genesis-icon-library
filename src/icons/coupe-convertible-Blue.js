...
const CoupeConvertibleBlue = props => {
...
CoupeConvertibleBlue.propTypes = {
...
CoupeConvertibleBlue.defaultProps = {
  color: 'currentColor',
  size: '48'
};

export default CoupeConvertibleBlue;
