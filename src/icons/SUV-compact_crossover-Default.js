...
const SuvCompactCrossoverDefault = props => {
  ...
  return (
    ...
    >
      <svg width="48" height="48" xmlns="http://www.w3.org/2000/svg">
        <g id="compact_crossover-Default">
...
SuvCompactCrossoverDefault.propTypes = {
...
SuvCompactCrossoverDefault.defaultProps = {
  color: 'currentColor',
  size: '48'
};

export default SuvCompactCrossoverDefault;
